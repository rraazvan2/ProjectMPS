...
<html>
	<head>
		...
		<body class="subpage">
			...
			<header id="header">
				<div class="logo">
					<a href="profil.php">Managementul
			...
			<section id="two" class="wrapper style2">
				<div class="inner">
                    ...
                    ?>
										...
										<input type="email" name="email" placeholder="Adresa de email" id="email" required width="20px" value = "<?php echo $email ?>">
												<br>
													<input type="submit" name="check-email" value="Continua">
														<br>
															<br>
																<br>
																	<div class="copyright">
