...
class dht11{
 ...
 function connect(){
  $this->link = mysqli_connect('localhost','amintiride','hO9c4pwkQQ') or die('Cannot connect to the DB');
  mysqli_select_db($this->link,'amintiride_site') or die('Cannot select the DB');
 }
